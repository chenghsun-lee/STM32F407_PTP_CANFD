...
typedef struct{
  ...
  u8 buffer[78];
	TimeInternal time;
//	u8 data_update; /*use to determine data update*/
//  __IO ETH_DMADESCTypeDef *descriptor;
}MACFrameTypeDef;

typedef struct{
	MACFrameTypeDef MACFrame[MACframe_QUEUE_SIZE];
	int16_t   head;  /*use to determine data update*/
	int16_t   tail;  /*use to determine data update*/
}MACFrameArray;
